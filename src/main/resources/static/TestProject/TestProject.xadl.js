(function()
{
    return function()
    {
        ...
        {
            var obj = new ChildFrame("childframe", "absolute", null, null, null, null, null, null, "Base::base_emp.xfdl", this);
            this.addChild(obj.name, obj);
            this.frame = obj;

            obj.set_formurl("Base::base_emp.xfdl");
        ...
        this.loadIncludeScript("TestProject.xadl", true);
    };
}
)();
